...
import (
	...
	"github.com/ctem/security-operator/internal/controller"
	// Feature plugins — blank imports trigger init() self-registration
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7738b711.ctem.io",
	...
	if err := (&controller.SecurityAgentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "SecurityAgent")
		os.Exit(1)
	}
