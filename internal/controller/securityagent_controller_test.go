...
var _ = Describe("SecurityAgent Controller", func() {
	Context("When reconciling a resource", func() {
		...
		securityagent := &securityv1alpha1.SecurityAgent{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind SecurityAgent")
			err := k8sClient.Get(ctx, typeNamespacedName, securityagent)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance SecurityAgent")
